...
- (void)showAlertView
{
    ...
    if (_strAlertTitle != nil && _strAlertTitle.length > 0)
    {
        ...
        if (_bDestructive)
            ...
            vTitle.backgroundColor = [UIColor colorWithRed:.95 green:.95 blue:.95 alpha:1.0];
    ...
    if (_doNo != nil)
    {
        ...
        btNo.frame = CGRectMake(0, dHeight, _vAlert.frame.size.width / 2.0 - 2, 40);
        btNo.backgroundColor = [UIColor colorWithRed:.95 green:.95 blue:.95 alpha:1.0];
        btNo.tag = DO_NO_TAG;
        [btNo setImage:[UIImage imageNamed:@"LeaderBoard.png"] forState:UIControlStateNormal];
    ...
    if (_doYes != nil)
    {
        ...
        if (_doNo == nil)
            ...
            btYes.frame = CGRectMake(_vAlert.frame.size.width / 2.0 + 1.0, dHeight, _vAlert.frame.size.width / 2.0 - 1.0, 40);

        btYes.backgroundColor = [UIColor colorWithRed:.95 green:.95 blue:.95 alpha:1.0];
        btYes.tag = DO_YES_TAG;
        [btYes setImage:[UIImage imageNamed:@"Play.png"] forState:UIControlStateNormal];
...
- (void)setLabelAttributes:(UILabel *)lb
{
    ...
    if (_bDestructive)
    {
        ...
        lb.textColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:1.0];
    }
    else
    {
